...
public:
    ...
    double getxTextureCoord() const noexcept { return xTextureCoord; }
    double getyTextureCoord() const noexcept { return yTextureCoord; }
    double getXMaxTextureCoord() const noexcept { return xMaxTextureCoord; }
    double getYMaxTextureCoord() const noexcept { return yMaxTextureCoord; }
    double getxOffset() const noexcept { return xOffset; }
    double getyOffset() const noexcept { return yOffset; }
    double getSizeX() const noexcept { return sizeX; }
    double getSizeY() const noexcept { return sizeY; }
    double getxAdvance() const noexcept { return xAdvance; }
